...
extern int		AlertMinsBefore	= -1;			// Set to -1 for no Alert
...
int		NewsCorner 			= 2;			// Choose which corner to place headlines 0=Upper Left, 1=Upper Right, 2=lower left , 3=lower right
...
//			Print(sTags[i], "  =  ", mainData[newsIdx][i]);
		...
		{   
			...
			minsTillNews = (newsTime - TimeGMT_()) / 60;
			if (DebugLevel > 2)
			{
